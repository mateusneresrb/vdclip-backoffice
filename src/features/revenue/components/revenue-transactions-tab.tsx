...
export function RevenueTransactionsTab() {
      ...
      <Tabs value={currencyTab} onValueChange={(v) => setCurrencyTab(v as Currency)}>
        ...
        <TabsContent value={currencyTab} className="mt-4">
          {isLoading ? (
            ...
            <EmptyState icon={Receipt} title={t('transactions.noResults')} description={t('transactions.noResultsHint')} />
          ) : (
